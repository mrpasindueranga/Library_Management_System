...
?>
  ...
  <head>
    ...
    <link rel="stylesheet" href="./resources/css/bookForm.css">
    ...
    <?php if (!isset($_GET['v_id']) && !isset($_GET['cr_id']) && !isset($_GET['d_id'])) : ?>
      <div class="find">
        <form action="./book.php">
          <div class="search">
            <input id="search" name="q" type="text" placeholder="Find a book...">
            <button type="submit">
        ...
        <a href="./book.php?cr_id=true">New</a>
      </div>
      <div class="card_container">
        <?php require_once '../../db/book_card.php'; ?>
      </div>
    <?php endif; ?>
    <?php if (isset($_GET['v_id']) || isset($_GET['cr_id'])) {
      echo '<h1 id="formHeading">Book Form</h1>';
      require '../form/book.php';
    } ?>

    <?php if (isset($_GET['d_id'])) {
      require '../../db/book_edit.php';
    } ?>
